...
Road::Road(glm::vec2 p1, glm::vec2 p2, glm::vec2 p3, glm::vec2 p4, GLfloat d, float start_space_b, float start_space_a){
        ...
        change_parameters(0, 0, 0, 0, 0, 0);
         ...
         std::string vertex_shader_file("v_road.glsl");
         std::string fragment_shader_file("f_road.glsl");
        ...
        // Load Textures
        tex1=LoadTexture("btex.bmp",526, 512);
        tex2=LoadTexture("rtex.bmp", 600, 340);
    ...
    cylinders(1.0f);
     std::string vertex_shader_file1("v_roadsep.glsl");
     std::string fragment_shader_file1("f_roadsep.glsl");
    ...
    void Road::render(){
       ...
       // glBindBuffer(GL_ARRAY_BUFFER, vbo);
        ...
        //std::cout<<num_cylinders<<std::endl;
