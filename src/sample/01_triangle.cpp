...
GLuint vbo, vao;
std::string shaderpath = "../../src/sample/";

void initShadersGL(void)
{
  std::string vertex_shader_file(shaderpath+"vertex-shaders/simple_vs.glsl");
  std::string fragment_shader_file(shaderpath+"fragment-shaders/simple_fs.glsl");
